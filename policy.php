...
which the Operator can obtain about website visitors <?php echo $_SERVER['SERVER_NAME']?>.
...
their availability on the Internet at the network address <?php echo $_SERVER['SERVER_NAME']?>;
...
the website <?php echo $_SERVER['SERVER_NAME']?>;
User – any visitor of the website <?php echo $_SERVER['SERVER_NAME']?>;
...
The Operator also has the right to send notifications to the User about new products and services, special offers and various events. The user can always refuse to receive informational messages by sending an email to the Operator at the policy email address@<?php echo $_SERVER['SERVER_NAME']?>  marked "Unsubscribe from notifications of new products and services and special offers".
...
The operator processes the User's personal data only if they are filled in and / or sent by the User independently through special forms located on the site <?php echo $_SERVER['SERVER_NAME']?> . By filling out the relevant forms and/or sending your personal data to the Operator, the User agrees to this Policy.
...
In case of detecting inaccuracies in personal data, the User can update them independently by sending a notification to the Operator's e-mail address policy@<?php echo $_SERVER['SERVER_NAME']?> marked "Updating personal data".
The term of personal data processing is unlimited. The user can revoke his consent to the processing of personal data at any time by sending a notification to the Operator via e-mail to the Operator's e-mail address policy@<?php echo $_SERVER['SERVER_NAME']?>  marked "Revocation of consent to the processing of personal data".
...
Final provision
The user can get any clarifications on issues of interest related to the processing of their personal data by contacting the Operator via e-mail policy@<?php echo $_SERVER['SERVER_NAME']?>.
This document will reflect any changes to the Operator's personal data processing policy. The policy is valid indefinitely until it is replaced with a new version.
 The current version of the Policy is freely available on the Internet at <?php echo $_SERVER['SERVER_NAME']?>/policy.php.
</pre>
</div>